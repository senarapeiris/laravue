        ...
        <div class="card mb-0">
            <div class="card-body">
                <a href="javascript:void(0);" class="brand-logo">
                    ...
                    <h2 class="brand-text text-primary ml-1">Lara Vue</h2>
                </a>

                <h4 class="card-title mb-1">HELLOW !! 👋</h4>
                ...
                <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" tabindex="4">Sign in <a href user.php ></button>
                </form>
